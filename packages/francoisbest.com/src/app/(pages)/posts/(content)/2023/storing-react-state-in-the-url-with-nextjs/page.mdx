export const metadata = {
  ...
  description:
    'A peek under the hood of the next-usequerystate 1.8.0 update with support for the app router.',
...
For more details on features, refer to the [documentation](https://github.com/47ng/next-usequerystate#readme).
