...
<StatusText className="max-w-xs mx-auto mb-4 dark:filter-invert" />
...
<StatusText className="max-w-xs mx-auto mb-4 dark:invert dark:hue-rotate-180" />

<VennDiagram className="mx-auto mb-4 dark:invert dark:hue-rotate-180" />
