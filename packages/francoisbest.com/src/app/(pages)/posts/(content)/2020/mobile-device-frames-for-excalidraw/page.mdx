...
import MobileMockup from './mobile-mockup.svg'
...
>
  <DiApple className="inline-block mr-1 -mt-1" /> Apple Device Frames
</a>
...
<Note title="License" icon={FiFileText}>
  ...
  (CC BY 4.0) license. You can use them for any purpose, but I'd appreciate you keep
  the attribution if you redistribute them.
</Note>
