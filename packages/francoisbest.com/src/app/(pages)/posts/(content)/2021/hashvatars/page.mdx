...
<Note status="warning" title="Public Service Announcement" >
  Since writing this article, I have moved from X <em>(formerly known as Twitter)</em> to Mastodon. [Follow me](https://mamot.fr/@Franky47) there
  instead.
...
<section className="flex text-sm justify-end items-center -mb-6">
...
<figure className="max-w-xs mx-auto mb-8">
  <AdjustableRadiusFactorSHA256Avatar
    className="mx-auto"
    showGrid
    showSections={false}
