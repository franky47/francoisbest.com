...
export const meta = {
  title: 'Password reset for E2EE apps',
...
If they did, it would be a terrible security design flaw on their part
...
Because everything happens on the client side in an E2EE app, the app cannot ask
