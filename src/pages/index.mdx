...
import { BrowserWindowFrame } from 'src/components/BrowserWindowFrame'
...
<Note
  ...
  icon={FiZap}
  title={
    <mark animationDelay={3000} fontSize={['lg', 'xl']}>
      Hire me!
    </mark>
  }
>
  <p my={6}>
    I build <b>web apps</b> for startups, businesses and public institutions as
    a freelance web developer and designer. Let's <b>discuss your needs</b> and
    what solutions I can bring.
  </p>
  <p my={6}>
    <em>
      <b>Note:</b> my earliest availability is <b>January 2022</b>.
    </em>
  </p>
  <ButtonRouteLink
    size="lg"
    href="mailto:contact+freelance@francoisbest.com"
    to="mailto:contact+freelance@francoisbest.com"
    leftIcon={<FiMail />}
    colorScheme="accent"
...
<Note>
  ...
  <ul my={3}>
    <li>
      <a href="/goals">My goals for 2021</a>
    </li>
    <li>
      I'm tracking <a href="/reading-list">all the blog posts I'm reading</a>{' '}
      this year
    </li>
  </ul>
</Note>
...
<PostReference
  frontMatter={featured1}
  shadow="none"
  borderColor={useColorModeValue('gray.300', 'gray.700')}
  mb={4}
/>
<PostReference
  frontMatter={featured2}
  shadow="none"
  borderColor={useColorModeValue('gray.300', 'gray.700')}
  mb={4}
/>
<PostReference
  frontMatter={featured3}
  shadow="none"
  borderColor={useColorModeValue('gray.300', 'gray.700')}
/>
...
- [Foggy](https://usefoggy.vercel.app) - Figma design to live og:image in one click <Badge textTransform="none">🚀 Shipped</Badge>
- [Repoverview](https://www.notion.so/47ng/Repoverview-f04949cf58b34b41b1422dbd378a5444) - Overview of GitHub repositories and cross-repo operations, currently building in the open <Badge>WIP</Badge>
...
<BrowserWindowFrame url="stravels.io" mb={12}>
  <Image
  ...
  description={
    <React.Fragment>
      ...
      <Note status="success" title="Add your business here">
        <p my={4}>You have a project you want to take further ?</p>
...
<a href="/sitemap" display="block" textAlign="center" fontSize="sm" mt={8}>
  <Icon as={FiMap} mr={2} display="inline-block" mt={-1} aria-hidden />
  Sitemap
</a>
