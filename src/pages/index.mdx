...
import { frontMatter as featured1 } from './posts/2021/hashvatars.mdx'
...
>
  ...
  <p my={6}>
    <em>
      <b>Note:</b> my earliest availability is <b>September 2022</b>.
    </em>
  </p>
  <ButtonRouteLink
    size="lg"
...
import HeronLogo from 'src/../public/images/icons/heron.svg'
...
<Experience
  ...
  description={
    <React.Fragment>
      <p>
        I'm doing freelance software development for startups, businesses and
        public institutions:
      </p>
      <ul>
        <Client
...
<Note status="success" icon={SiSpotify}>
  Check out my{' '}
  <OutgoingLink
