...
<Note title="Did you know ?" status="info">
  <em>
    The <code>--</code> after <code>cargo run</code> is a Unix trick to pass the
    arguments to our program and not to cargo itself.
  </em>
</Note>
...
<WideContainer>
  <img
    src="/images/posts/2019/strava-auth-cli-in-rust/strava-auth-page.png"
    alt="Strava authorization page"
  />
</WideContainer>
...
This is what it would look like _(spoiler alert: this code won't compile yet)_ :
