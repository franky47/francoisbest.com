...
[^1]: It's not always easy to know what an app does when you can't read its source code.<br/>I use [Bitwarden](https://bitwarden.com) to manage my passwords especially because it is [open-source](https://github.com/bitwarden).
