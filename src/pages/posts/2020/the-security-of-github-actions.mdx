...
<Note status="success" title="Update 2020-12-25">
  Dependabot now supports SHA-1 pinning updates, when using the built-in version
  built-in GitHub:
</Note>

<Tweet {...require('twitter:1342371205144309760')} mb={0} />
...
<Note title="Update 2020-09-02" status="warning">
  <em>
    ...
    following{' '}
    <OutgoingLink
      href="https://github.com/docker/build-push-action/issues/10"
      textDecoration="underline"
    >
      GitHub issue on Docker's action
    </OutgoingLink>
    .
  </em>
</Note>
