...
<Button
  ...
  variantColor="accent"
  href="https://excalidraw.com/#json=5130245329911808,2QMzeWu-qeg3YCHZfe75iA"
  leftIcon={DiApple}
  w={['100%', 'auto']}
  mb={[2, 8]}
  mr={[0, 2]}
...
- [`apple-device-frames.excalidraw`](/images/posts/2020/mobile-device-frames-for-excalidraw/apple-device-frames.excalidraw)
