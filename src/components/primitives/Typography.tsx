...
import { Heading, useColorMode, Text, HeadingProps } from '@chakra-ui/core'
...
export const H2 = (p: HeadingProps) => (
  <Heading as="h2" mt={6} mb={4} size="lg" {...p} />
)
export const H3 = (p: HeadingProps) => (
  <Heading as="h3" mt={6} mb={4} size="lg" {...p} />
)
export const H4 = (p: HeadingProps) => (
  <Heading as="h4" mt={6} mb={4} size="md" {...p} />
)
export const H5 = (p: HeadingProps) => (
  <Heading as="h5" mt={6} mb={4} size="sm" {...p} />
)
